...
if (isset($btn['btnApagar'])){
    $b->apagar($btn['btnApagar'],'pedidos');
    unset($btn['btnApagar']);
}
//pesquisa
$pesquisa = 'padrao';

if (isset($btn['situacao'])){
    $situacao = $btn['situacao'];
}else{
    $situacao = 'padrao';
}
        ...
        <div class="row">
                ...
                <div class="panel panel-default" style="margin-top: 20px;">
                    ...
                    <div class="panel-body">
                        <form class="form-group" action="" method="post">
                            <input type="text" placeholder="Digite o nome do cliente" name="nome" class="form-control">
            ...
            <div class="col-md-12">
                <table class="table">
                    ...
                    <tbody>
                    <?php
                    $b->mostrarPedidos($pesquisa,$situacao);
                    ?>
                    </tbody>
                </table>
            </div>

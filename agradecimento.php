...
<div class="container-fluid" style="margin-top: 55px; background-color: #1b1b1b">
    <div class="row">
        ...
        <div class="col-12 col-md-8">
            ...
            <img src="recursos/imagens/agradecimento.jpg" class="img-fluid" alt="Responsive image agradecimento">
        </div>
    </div>
</div>
<footer id="myFooter">
